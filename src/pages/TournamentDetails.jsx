...
const TournamentDetails = () => {
  ...
  const [leaguesRefreshKey, setLeaguesRefreshKey] = useState(0); // To trigger leagues refresh
    ...
    return (
      ...
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          ...
          <h3 className="text-xl font-semibold text-[#273470] mb-2">Loading Tournament...</h3>
          <p className="text-gray-600">Please wait while we fetch the tournament <details></details></p>
        </div>
      </div>
    );
  }
    ...
    <main className="min-h-screen bg-gradient-to-br from-blue-50 to-slate-100">
      <section className="max-w-[1440px] mx-auto px-4 py-8">
        ...
        <div className="flex gap-1 bg-white rounded-lg p-1 shadow-sm mb-6 border border-gray-200">
          <button
            ...
            className={`flex-1 px-4 py-3 rounded-md font-semibold text-sm transition-all ${activeTab === "matches"
          ...
          <button
            ...
            className={`flex-1 px-4 py-3 rounded-md font-semibold text-sm transition-all ${activeTab === "leagues"
                ? "bg-[#273470] text-white shadow-md"
                : "text-gray-600 hover:text-gray-800 hover:bg-gray-50"
              }`}
          >
          ...
          <button
            ...
            className={`flex-1 px-4 py-3 rounded-md font-semibold text-sm transition-all ${activeTab === "leaderboard"
                ? "bg-[#273470] text-white shadow-md"
                : "text-gray-600 hover:text-gray-800 hover:bg-gray-50"
              }`}
          >
              ...
              <div className="text-center py-20 bg-white rounded-2xl border border-gray-200 shadow-sm">
                ...
                {filterStatus !== 'all' && (
                  <button
                    ...
                    className="mt-4 px-6 py-2 bg-[#273470] hover:bg-[#273470] text-white rounded-lg transition-colors"
                  >
                    Show All Matches
                  </button>
                )}
                        ...
                        <div className="space-y-3">
                          {leaderboard.map((entry, index) => {
                            ...
                            return (
                              <div
                                key={entry._id || index}
                                className={`flex items-center justify-between p-4 rounded-xl transition-all hover:shadow-md ${index < 3 ? 'bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200' : 'bg-gray-50 hover:bg-gray-100'
                                  }`}
                              >
      ...
      <CreateTournamentLeague
        ...
        onSuccess={(league) => {
          ...
          // Trigger leagues refresh by changing the key
          setLeaguesRefreshKey(prev => prev + 1);
        }}
      />
    </main>
  );
