...
const TournamentLeagues = ({ tournament }) => {
  ...
  const ShareModal = () => {
    ...
    return (
      <div
        className="fixed inset-0 bg-[#98a2b3] bg-opacity-80 flex items-center justify-center z-50 p-4"
      ...
      >
        ...
        >
          ...
          <div className="mb-8 pr-12">
            <h3 className="text-2xl font-semibold text-gray-900 mb-2">Share</h3>
          </div>

          {/* Share this link via */}
          <div className="mb-6">
            <h4 className="text-lg font-medium text-gray-900 mb-4">Share this link via</h4>

            {/* Platform Icons - Horizontal Layout */}
          ...
          {/* Page Link Section */}
          <div>
            <h4 className="text-lg font-medium text-gray-900 mb-4">Page link</h4>
          ...
          >
            <div className="flex items-start justify-between">
              ...
              <div className="flex items-center space-x-3 ml-6">
                ...
                {league.isUserMember ? (
                  <div className={`px-6 py-2 text-sm rounded-lg flex items-center space-x-2 ${league.userRole === 'OWNER' ? 'bg-purple-100 text-purple-700' :
